...
namespace Bitcoin.APIClient
{
  interface IRPCClient
  {
    ...
    void GetAccount(string a_address);

    /// <summary>
    /// Returns the current bitcoin address for receiving payments to this account.
    /// </summary>
    /// <param name="a_account"></param>
    void GetAccountAddress(string a_account);

    /// <summary>
    /// Returns the list of addresses for the given account.
    /// </summary>
    /// <param name="a_account"></param>
    void GetAddressesByAccount(string a_account);
    ...
    void GetBalance(string a_account = "", int a_minconf = 1);
    ...
    /// </summary>
    /// <param name="a_account"></param>
    void GetNewAddress(string a_account);
    ...
    void GetTransaction(string a_txid);
    ...
    void ListTransactions(string a_account, int a_count = 10);
    ...
    void SendFrom(string a_fromAccount, string a_toAddress, float a_amount, int a_minconf = 1, string a_comment = "",
      string a_commentTo = "");
    ...
    /// <param name="a_comment"></param>
    /// <param name="a_commentTo"></param>
    void SendToAddress(string a_address, decimal a_amount, string a_comment, string a_commentTo);
    ...
    /// </summary>
    /// <param name="a_amount"></param>
    void SetTxFee(double a_amount = 0.0001);
    ...
    /// </summary>
    /// <param name="a_address"></param>
    void ValidateAddress(string a_address);

    /// <summary>
    /// Methoda for Password Second
    /// Return Boolen
    /// </summary>
    /// <param name="a_pass"></param>
    /// <param name="a_timeout"></param>
    void WalletPassPhrase(string a_pass, int a_timeout);

    /// <summary>
    /// Methoda for Password Second change.
    /// </summary>
    /// <param name="a_passodl"></param>
    /// <param name="a_passnew"></param>
    void WalletPassPhraseChange(string a_passodl, string a_passnew);
  }
}
