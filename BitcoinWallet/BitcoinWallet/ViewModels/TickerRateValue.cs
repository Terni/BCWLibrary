...
namespace BitcoinMyWallet.ViewModels
{
    ...
    //{
    //    public TickerRateValueArray USD { get; set; }
    //    public TickerRateValueArray CNY { get; set; }
    //    public TickerRateValueArray JPY { get; set; }
    //    public TickerRateValueArray SGD { get; set; }
    //    public TickerRateValueArray HKD { get; set; }
    //    public TickerRateValueArray CAD { get; set; }
    //    public TickerRateValueArray NZD { get; set; }
    //    public TickerRateValueArray AUD { get; set; }
    //    public TickerRateValueArray CLP { get; set; }
    //    public TickerRateValueArray GBP { get; set; }
    //    public TickerRateValueArray DKK { get; set; }
    //    public TickerRateValueArray SEK { get; set; }
    //    public TickerRateValueArray ISK { get; set; }
    //    public TickerRateValueArray CHF { get; set; }
    //    public TickerRateValueArray BRL { get; set; }
    //    public TickerRateValueArray EUR { get; set; }
    //    public TickerRateValueArray RUB { get; set; }
    //    public TickerRateValueArray PLN { get; set; }
    //    public TickerRateValueArray THB { get; set; }
    //    public TickerRateValueArray KRW { get; set; }
    //    public TickerRateValueArray TWD { get; set; }
    //}
